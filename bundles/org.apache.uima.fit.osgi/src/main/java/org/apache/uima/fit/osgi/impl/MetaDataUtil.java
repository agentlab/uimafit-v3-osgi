...
public final class MetaDataUtil {
   ...
   */
  public static String[] scanImportsAndManifests(ResourcePatternResolver resolver, MetaDataType aType)
          throws ResourceInitializationException {
    ...
    // Scan manifest
    for (String mfUrl : resolve(resolver, getManifestLocations(aType))) {
      InputStream is = null;
      try {
   ...
   */
  public static String[] resolve(ResourcePatternResolver resolver, String... patterns) throws ResourceInitializationException {
  ...
  public static String[] getManifestLocations(MetaDataType aType) {
    ...
    switch (aType) {
      case FS_INDEX:
        locations.add("META-INF/org.apache.uima.fit/fsindexes.txt");
        break;
      case TYPE_SYSTEM:
        locations.add("META-INF/org.apache.uima.fit/types.txt");
        break;
      case TYPE_PRIORITIES:
        locations.add("META-INF/org.apache.uima.fit/typepriorities.txt");
        break;
    }
   ...
   *           if the locations could not be resolved.
   */
  public static String[] scanDescriptors(ResourcePatternResolver resolver, MetaDataType aType)
          throws ResourceInitializationException {
    String[] locations1 = resolve(resolver, scanImportsAndManifests(resolver, aType));
